...
" Tito just changed the dark theme background color to be a darker back for
" higher contrast.
"
" Based work by Maintainer:	Pan, Shi Zhu <Go to the following URL for my email>
" Entirely based on:		http://vim.sourceforge.net/scripts/script.php?script_id=760
" Based on Last Change:	19 May 2011
